defmodule PaymentsWeb.ProjectControllerTest do
  use PaymentsWeb.ConnCase

  alias Payments.Projects

  @create_attrs %{id: "io.elementary", private: true}
  @update_attrs %{id: "io.elementary", private: false}
  @invalid_attrs %{id: nil, private: nil}
  ...
  describe "create project" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ @create_attrs.id
    end
  ...
  describe "edit project" do
    ...
    test "renders form for editing chosen project", %{conn: conn, project: project} do
      ...
      assert html_response(conn, 200) =~ "Edit #{project.id}"
    end
  end
  ...
  describe "update project" do
    ...
    test "redirects when data is valid", %{conn: conn, project: project} do
      ...
      assert html_response(conn, 200) =~ "io.elementary"
    end
